...
namespace CringeLazer.Bancho.Migrations
{
    ...
    [Migration("20221023133247_AddFriends")]
...
#pragma warning disable 612, 618
            ...
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "playstyles", new[] { "keyboard", "mouse", "tablet", "touch" });
            NpgsqlModelBuilderExtensions.HasPostgresEnum(modelBuilder, "profile_page", new[] { "me", "recent_activity", "beatmaps", "historical", "kudosu", "top_ranks", "medals" });
            NpgsqlModelBuilderExtensions.UseIdentityByDefaultColumns(modelBuilder);

            modelBuilder.Entity("CringeLazer.Core.Models.FriendsModel", b =>
                {
            ...
            modelBuilder.Entity("CringeLazer.Core.Models.Users.UserModel", b =>
                {
                    ...
                    b.Property<List<History>>("MonthlyPlayCounts")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("monthly_playcounts");
                    ...
                    b.Property<Gamemode>("Playmode")
                        .HasColumnType("gamemode")
                        .HasColumnName("playmode");

                    b.Property<List<Playstyles>>("Playstyle")
                        .HasColumnType("playstyles[]")
                        .HasColumnName("playstyle");
                    ...
                    b.Property<List<ProfilePage>>("ProfileOrder")
                        .HasColumnType("profile_page[]")
                        .HasColumnName("profile_order");

                    b.Property<List<History>>("ReplaysWatchedCounts")
                        .IsRequired()
                        .HasColumnType("jsonb")
                        .HasColumnName("replays_watched");
            ...
            modelBuilder.Entity("CringeLazer.Core.Models.FriendsModel", b =>
                {
                    b.HasOne("CringeLazer.Core.Models.Users.UserModel", "Issuer")
                        .WithMany("Friends")
                        .HasForeignKey("IssuerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CringeLazer.Core.Models.Users.UserModel", "Receiver")
                        .WithMany()
